...
if __name__ == "__main__":
	...
	with profiler.profile(activities=[profiler.ProfilerActivity.CUDA], profile_memory=True) as p:
		main(world_size, rank, global_rank)

	print(
		f"[GPU {global_rank}] :", p.key_averages().table(sort_by="self_cuda_time_total", row_limit=-1)
	)
