from ..partitioners.profile import *
import pytest
...
def test_profile():
    def check_model(model, sample):
        ...
        assert memory_after - memory_before < 100e6, f"Memory leak detected: Before {memory_before}, After {memory_after}, diff = {memory_after - memory_before}"
